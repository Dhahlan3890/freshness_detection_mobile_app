...
class _ScanTabState extends State<ScanTab> with SingleTickerProviderStateMixin {
  ...
  Future<void> _analyzeImage() async {
    ...
    try {
      ...
      final apiUrl = 'https://your-model-api.com/predict';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  String _apiEndpoint = 'https://your-model-api.com/predict';
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _apiEndpoint = prefs.getString('api_endpoint') ?? 'https://your-model-api.com/predict';
    });
  }
